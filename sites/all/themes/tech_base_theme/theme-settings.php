...
/**
 * USAGE:
 * 1 - To use this file replace "tech_base_theme" with the name of
...
// Replace 'tech_base_theme' with your themes name, eg:
// function your_themes_name_form_system_theme_settings_alter(&$form, &$form_state)
function tech_base_theme_form_system_theme_settings_alter(&$form, &$form_state)  {
